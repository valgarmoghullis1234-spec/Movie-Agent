...
LOCAL_PROMPTS: dict[str, str] = {
    ...
    "streaming": (
        ...
        "names a country, pass its 2-letter code; otherwise use the country from USER LOCATION "
        "in the system context (default to US if no location is set). Do not announce the "
        "country unless it differs from what the user might expect.\n"
